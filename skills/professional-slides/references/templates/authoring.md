...
- `Analytical jobs`: evidence obligations routed to shared slide-type and chart owners;
...
Link to `../storylining/pre-authoring-contract.md` and `../slide-types/index.md`. Templates must not redefine shared storylining, components, charts, design tokens, platform mechanics, or evaluation rules.
