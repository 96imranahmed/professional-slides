...
| Narrative job | Read |
| --- | --- |
| State the whole answer and supporting logic | [Executive synthesis](executive-synthesis.md) |
| Explain causes, drivers, or issue structure | [Decomposition](decomposition.md) |
| Prove a quantitative conclusion | [Chart-led insight](chart-led-insight.md) |
| Compare alternatives or tradeoffs | [Comparison and options](comparison-options.md) |
...
Every analytical slide must define:

- one narrative job;
- one primary claim;
- an action title that states the conclusion;
- one dominant exhibit;
- the evidence that supports the claim;
- the implication for the audience;
