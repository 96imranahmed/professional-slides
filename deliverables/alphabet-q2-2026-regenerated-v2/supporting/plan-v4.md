...
1. **Dot:** Q2 2026 Investment Review
   - **Dash:** Company-only subtitle: “Alphabet”. No thesis, methodology or provenance paragraph on the cover.
   - **Dash:** The executive summary carries the conditional recommendation; evidence pages and the source ledger retain the reporting and price-snapshot details.
