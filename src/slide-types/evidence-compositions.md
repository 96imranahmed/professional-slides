...
Set primary section boundaries on the [design grid](../design/index.md#canvas-guides-and-grid), use the [spacing scale](../design/index.md#spacing-system), and choose the enclosing, open, or highlighted-header treatment through [component guidelines](../components/guidelines.md). The active theme owns colours, typography, rules, surfaces, and insight-region variants.
