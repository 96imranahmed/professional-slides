...
Place score definitions, weights, and missing-value treatment in the slide or notes. Use `N/A` for non-applicable and an em dash only for a genuinely unavailable value inside a data table; do not silently score missing evidence as zero.
