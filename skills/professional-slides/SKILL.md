...
5. Choose the [exhibit and its capacity](references/design/index.md#allocate-evidence-before-geometry) from the actual rows, categories, periods and text. Resolve registered variants and their required inputs before export. Preserve comparable page families and use measured content to allocate space.
