...
CHART_FURNITURE_ROLES = {"axis-label", "category-label", "data-label", "legend-label", "table-status-label", "table-lamp", "table-progress-label", "chart-bracket-label", "chart-delta-label", "chart-period-label", "chart-event-label", "chart-unit"}
...
def is_cover(slide, index):
    ...
    if components & {"cover", "section-divider", "agenda", "tracker-page", "takeaways"}:
        return True
