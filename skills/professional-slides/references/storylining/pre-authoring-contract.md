...
Before production, confirm that every required field is present, slide counts reconcile, every approved dot maps to exactly one slide record, tracker labels and ranges are internally consistent, the executive-summary disposition matches the workflow, and approval evidence points to the reviewed dot-dash.
