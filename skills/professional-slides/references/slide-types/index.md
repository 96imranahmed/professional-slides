...
- Establish node centers or edges on the [`design` grid](../design/index.md#canvas-guides-and-grid) before drawing connectors. Derive node padding and peer gaps from the [theming spacing scale](../theming/tokens.md#primitive-and-role-tokens).
