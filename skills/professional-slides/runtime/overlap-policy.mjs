...
export const OVERLAP_POLICY = Object.freeze({
  ...
  pairs: [
    ...
    ["table-cell", "table-section-marker", "section marker sits at the left of its category cell"],
    ["table-cell", "table-section-number", "section number sits inside its marker"],
    ["table-header-cell", "table-rule", "table rule sits on its own header boundary"],
    ["table-label-column", "table-rule", "row rules cross the filled label column"],
    ["table-label-column", "table-zebra-band", "the label column is one surface over the row bands"],
    ["table-label-column", "table-row-band", "a total or group band paints over the label column"],
    ["chart-row-band", "chart-line", "a dumbbell's bar sits on its own row band"],
    ["chart-row-band", "chart-mark", "a dumbbell's dots sit on their own row band"],
    ["cycle-hub", "cycle-center", "the loop's name sits on its hub"],
