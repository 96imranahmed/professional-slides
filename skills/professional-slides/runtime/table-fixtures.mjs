...
export const TABLE_VARIANTS={
 'status-report':{preferredSize:size,props:{treatment:'standard',columns:[text('Workstream',.26),text('Status',.18,'rag'),text('Health',.14,'lights'),text('Complete',.18,'progress'),text('Gate',.12,'dot'),text('Signed off',.12,'check')],rows:[['Stream Alpha',{value:'at-risk'},{value:'red'},{value:40},{value:true},{value:'no'}],['Stream Beta',{value:'behind'},{value:'amber'},{value:65},{value:false},{value:'no'}],['Stream Gamma',{value:'on-track'},{value:'green'},{value:80},{value:true},{value:'yes'}],{style:'total',cells:['Programme',{value:'behind'},{value:'amber'},{value:62},{value:true},{value:'no'}]}]}},
